...
fun PomodoroPlayScreen(
    ...
    var remainSeconds by remember { mutableStateOf(25 * 60) }
    var isRestTime by remember { mutableStateOf(false) }
...
@Composable
fun PomodoroPlayScreenHeaderPreview() {
    // 프리뷰용 더미 상태
    var isGroupSelected by remember { mutableStateOf(true) }
